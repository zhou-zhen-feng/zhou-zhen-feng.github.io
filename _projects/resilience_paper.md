---
layout: page
title: "Evaluating the Brief Resilience Scale in 21 Countries: Psychometric Properties and Measurement Invariance Across Sex, Age, and Countries"
---
...
<div style="max-width: 900px; margin: 40px auto; font-family: Arial, sans-serif; line-height: 1.7; color: #333;">
  ...
  <h2 style="font-weight: bold; text-align: center; margin-bottom: 12px; font-size: 20px; line-height: 1.4;">
    Evaluating the Brief Resilience Scale in 21 Countries:<br>
    Psychometric Properties and Measurement Invariance Across Sex, Age, and Countries
  </h2>
